...
|:----|:-----|:------|:-----------------------------------------|
|[kc_house.csv](`r noquote(baselink)`/1_Data/kc_house.csv) | 21613 | 11|Verkaufspreise von Häusern in King County zwischen Mai 2014 und Mai 2015. |
|[bevoelkerung.csv](`r noquote(baselink)`1_Data/bevoelkerung.csv) | 161 | 10|Einwohnerzahlen Schweizer Städte von 1930 bis 2011. |

...
Siehe die `ggplot2` [**Webseite**](https://ggplot2.tidyverse.org/) und Selva Prabhakaran's [**Webseite**](https://r-statistics.co/Top50-Ggplot2-Visualizations-MasterList-R-Code.html) mit inspirierenden `ggplot2` Beispielen. 

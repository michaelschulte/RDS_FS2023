...
<font style="font-size:10px">adapted from [paherald.sk.ca](https://www.trueloveproperty.co.uk/houses-sale-ingham/)</font>
</p>
...
4. Lade `tidyverse`, `viridis`, `ggthemes` und `patchwork`.
...
```{r, echo = TRUE, eval = FALSE}
ggsave(filename = "3_Plots/verbrechen.pdf", 
       device = "pdf", 
       plot = verbrechen_gg,
       width = 4, 
       height = 4, 
...
- Siehe die `ggplot2` [**Webseite**](https://ggplot2.tidyverse.org/).

- Selva Prabhakaran's [**Webseite**](https://r-statistics.co/Top50-Ggplot2-Visualizations-MasterList-R-Code.html) mit inspirierenden `ggplot2` Beispielen. 

### Cheatsheets

<p align="center" width="100%">
<a href="https://www.rstudio.com/wp-content/uploads/2015/03/ggplot2-cheatsheet.pdf">
  <img src="https://www.rstudio.com/wp-content/uploads/2015/03/ggplot2-cheatsheet.png" style="width:70%"></a>
  <br>
